...
def yolov5_post_process(input_data,anchors):
...
def myFunc_det(rknn_lite, IMG,anchors,classes):
    ...
    boxes, classes, scores = yolov5_post_process(input_data,anchors)

    IMG = cv2.cvtColor(IMG, cv2.COLOR_RGB2BGR)
    
    if boxes is not None:
        draw(IMG, boxes, scores, classes,classes_choice)
